    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Book, BookDto>()
                .ForMember(dest => dest.Authors, opt => opt.MapFrom(s => s.BookAuthors.Select(m => m.Author.FullName)));
            CreateMap<BookCreateDto, Book>();
            CreateMap<BookEditDto, Book>();

            CreateMap<Author, AuthorDto>()
                .ForMember(dest => dest.Books, opt => opt.MapFrom(s => s.BookAuthors.Select(m => new BookDto
                {
                    Id = m.Id,
                    Name = m.Book.Name
                })));
            ...
            CreateMap<BookAuthorCreateDto, BookAuthors>();
        }
    }
}
